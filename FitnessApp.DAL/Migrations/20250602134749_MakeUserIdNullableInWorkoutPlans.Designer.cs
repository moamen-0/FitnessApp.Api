...
namespace FitnessApp.DAL.Migrations
{
    ...
    [Migration("20250602134749_MakeUserIdNullableInWorkoutPlans")]
    partial class MakeUserIdNullableInWorkoutPlans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessApp.Core.Entities.ExercisePerformance", b =>
                {
                    ...
                    b.ToTable("ExercisePerformances");
                });
            ...
            modelBuilder.Entity("UserFavoriteExercises", b =>
                {
                    ...
                    b.HasKey("ApplicationUserId", "FavoriteExercisesId");

                    b.HasIndex("FavoriteExercisesId");

                    b.ToTable("UserFavoriteExercises");
                });

            modelBuilder.Entity("UserFavoriteMeals", b =>
                {
                    b.Property<string>("ApplicationUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("FavoriteMealsId")
                        .HasColumnType("int");

                    b.HasKey("ApplicationUserId", "FavoriteMealsId");

                    b.HasIndex("FavoriteMealsId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FitnessApp.Core.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UserFavoriteExercises", b =>
                {
                    ...
                    b.HasOne("FitnessApp.Core.Entities.Exercise", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UserFavoriteMeals", b =>
                {
                    ...
                    b.HasOne("FitnessApp.Core.Entities.Meal", null)
                        .WithMany()
                        .HasForeignKey("FavoriteMealsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
